function App() {
  ...
  return /*#__PURE__*/(
    ...
    React.createElement("h3", null, "Your ToDo list"), /*#__PURE__*/

    React.createElement("div", null, /*#__PURE__*/
    React.createElement("input", {
      value: input,
      onChange: e => setInput(e.target.value),
      placeholder: "add your item here" })), /*#__PURE__*/


    React.createElement("div", null, /*#__PURE__*/
    React.createElement("button", { onClick: () => addTodo(input) }, "Add item")), /*#__PURE__*/

    React.createElement("div", null, /*#__PURE__*/
    React.createElement("ul", null,
    list.map((todo) => /*#__PURE__*/
    React.createElement("li", { key: todo.id }, todo.todo))))));
